...
namespace RFIDClient.Desktop
{
    public class UserViewModel : BaseViewModel
    {
        ...
        public UserViewModel()
        {
            ...
            CloseCommand = new RelayParameterizedCommand(async (parameter) => Close(parameter));
        }

        private void Close(object parameter)
        {
            IoC.Get<ApplicationViewModel>().GoToPage(ApplicationPage.Receipt, PageHistory.PreviousPage);
        }
        ...
        public async Task InsertAsync(object parameter)
        {
            ...
            try
            {
                ...
                await UserRepositoryServiceFactory.Service.Insert(new UserService
                {
                    ...
                    Password = RFIDClient.Desktop.Core.SecureStringHelpers.HashSHA1(newUser.Password.ToString()),
