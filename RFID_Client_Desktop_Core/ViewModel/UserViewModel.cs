...
//            CloseCommand = new RelayParameterizedCommand(async (parameter) => await Close(parameter));
//        }

//        private Task Close(object parameter)
//        {
//            IoC.Get<ApplicationViewModel>().GoToPage(ApplicationPage.Receipt,PageHistory.)
//        }
...
//                    Password = SecureStringHelpers.HashSHA1(newUser.Password.ToString()),
